...
<div class="weadmin-body">
    <form class="layui-form" method="post" action="../../AddBusServlet">
        <div class="layui-form-item">
            <label class="layui-form-label">自编号</label>
            <div class="layui-input-block">
                <input type="text" name="number" lay-verify="title" autocomplete="off" placeholder="请输入配车自编号"
                       class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="brand" lay-verify="title" autocomplete="off" placeholder="请输入配车品牌"
                       class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="route" lay-verify="title" autocomplete="off" placeholder="请输入运营线路"
                       class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="model" lay-verify="title" autocomplete="off" placeholder="请输入型号"
                       class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
