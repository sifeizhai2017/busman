...
<div class="weadmin-body">
    <form class="layui-form" method="post" action="../../AddRouteServlet">
        <div class="layui-form-item">
            <label class="layui-form-label">线路名</label>
            <div class="layui-input-block">
                <input type="text" name="name" lay-verify="title" autocomplete="off" placeholder="请输入线路名"
                       class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="time" lay-verify="title" autocomplete="off" placeholder="请输入发车时间"
                       class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="start" lay-verify="title" autocomplete="off" placeholder="请输入首站"
                       class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="end" lay-verify="title" autocomplete="off" placeholder="请输入尾站"
                       class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="via" lay-verify="title" autocomplete="off" placeholder="请输入经停站"
                       class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="count" lay-verify="title" autocomplete="off" value="0" readonly="readonly"
                       class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="price" lay-verify="title" autocomplete="off" placeholder="请输入票价"
                       class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="seat" lay-verify="title" autocomplete="off" placeholder="请输入座位数"
                       class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
