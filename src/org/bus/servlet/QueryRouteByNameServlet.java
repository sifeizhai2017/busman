...
@WebServlet(urlPatterns = "/QueryRouteByNameServlet")
public class QueryRouteByNameServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.getRequestDispatcher("pages/route/edit.jsp").forward(request, response);
    }
}
