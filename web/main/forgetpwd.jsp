                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="${path}/main/ShowTickets">验票</a></li>
...
<div class="main-wrapper">
    <div class="page-header">
        <h1>忘记密码 <small>Change Password</small></h1>
    </div>
    <div>
        <form action="${path}/ChangePasswordServlet">
            请输入你的新密码：<br><br>
            <input type="text" name="newpwd" class="form-control" placeholder="Text input">
        </form>
    </div>
</div>
<footer class="footer ">
