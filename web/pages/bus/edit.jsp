...
<div class="weadmin-body">
    <form class="layui-form" method="post" action="${path}/UpdateBusServlet">
        <div class="layui-form-item">
            <label class="layui-form-label">自编号</label>
            <div class="layui-input-block">
                <input type="text" name="number" lay-verify="title" autocomplete="off" value="<%=bus.getNumber()%>"
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="brand" lay-verify="title" autocomplete="off" value="<%=bus.getBrand()%>"
                       class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="route" lay-verify="title" autocomplete="off" value="<%=bus.getRoute()%>"
                       class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="model" lay-verify="title" autocomplete="off" value="<%=bus.getModel()%>"
                       class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
