...
<div class="weadmin-body">
    <form class="layui-form" method="post" action="${path}/UpdateUserServlet">
        <div class="layui-form-item">
            <label class="layui-form-label">用户名</label>
            <div class="layui-input-block">
                <input type="text" name="uname" lay-verify="title" autocomplete="off" value="<%=user.getUname()%>"
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="upwd" lay-verify="title" autocomplete="off" value="<%=user.getUpwd()%>"
                       class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="ubalance" lay-verify="title" autocomplete="off" value="<%=user.getUbalance()%>"
                       class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
